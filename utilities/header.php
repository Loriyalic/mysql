...
<head>
    ...
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="/Applications/MAMP/htdocs/MYSQL/assets/favicon/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="/Applications/MAMP/htdocs/MYSQL/assets/favicon/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="/Applications/MAMP/htdocs/MYSQL/assets/favicon/favicon-16x16.png">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid px-4 px-lg-5">
            <a class="navbar-brand align-item-center" href="<?= $index_page; ?>"> <img src="/Applications/MAMP/htdocs/MYSQL/assets/img/logo.png" alt="Logo" width="67" height="24" class="d-inline-block">Cinéma Utopia</a>
